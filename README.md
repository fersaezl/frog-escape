...
- **Duración de la partida:** Llegar a 1000 puntos
...
El objetivo es esquivar los obstáculos que aparecen en pantalla mediante saltos o agachándose, intentando sobrevivir el mayor tiempo posible y obtener la máxima puntuación.  
...
- Puede:  
  - Saltar para esquivar obstáculos bajos  
  - Agacharse para esquivar obstáculos altos  
...
- Tipos de obstáculos:  
  - Obstáculos bajos (requieren salto)  
  - Obstáculos altos (requieren agacharse)  
...
- Al pulsar el botón, la partida comienza de nuevo desde el inicio.
...
- Fondo estático o con movimiento ligero.
...
- Escena principal (`Main`)  
- Escena del jugador (`Player`)  
- Escena de obstáculos (`Obstacle`)  
- Sistema de generación de obstáculos (`Spawner`)  
